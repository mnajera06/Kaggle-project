...
**Summary** of the performance: The decision tree was a success and achieved 100% accurecy on the test and validation sets. The confusion matrix and ROC curve even confirm this by showing no false positives or negatives.
...
## Data Visualization
The distribution was approximately 51.8% edible and 48.2% poisonous, making the dataset well balanced.
